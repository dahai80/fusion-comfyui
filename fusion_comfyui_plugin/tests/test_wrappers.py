...
class TestFusionModelWrapper:
    ...
    def test_get_engine_creates(self):
        from fusion_comfyui.core.wrappers import FusionModelWrapper
        with patch("fusion_comfyui.core.engine_wrapper.FusionEngineWrapper") as MockEngine:
    ...
    def test_get_engine_cached(self):
        from fusion_comfyui.core.wrappers import FusionModelWrapper
        with patch("fusion_comfyui.core.engine_wrapper.FusionEngineWrapper") as _MockEngine:
            w = FusionModelWrapper(model_path="/tmp/m", model_name="test", model_type="video")
            e1 = w.get_engine()
            e2 = w.get_engine()
            assert e1 is e2
...
class TestFusionConditioning:
    def test_with_embed(self):
        from fusion_comfyui.core.wrappers import FusionConditioning
        embed = MagicMock()
...
class TestMapCheckpoint:
    ...
    def test_sd15(self):
        ...
        assert _map_checkpoint_to_model_name("sd-v1-5.ckpt") == "runwayml/stable-diffusion-v1-5"
...
class TestMapUnetName:
    def test_wan22_14b(self):
        ...
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.2-14B"):
    ...
    def test_wan21_14b(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.1-14B"):
            result = _map_unet_name_to_model_name("wan2.1-14b")
            assert result == "Wan2.1-14B"

    def test_wan21_1b(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.1-1.3B"):
    ...
    def test_skyreels_default(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="SkyReels-V3-V2V-14B-MLX"):
            result = _map_unet_name_to_model_name("skyreels-v3")
            assert result == "SkyReels-V3-V2V-14B-MLX"

    def test_skyreels_a2v(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="SkyReels-V3-A2V-19B-MLX"):
    ...
    def test_skyreels_r2v(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="SkyReels-V3-R2V-14B-MLX"):
    ...
    def test_wan22_ti2v(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.2-TI2V-5B-mlx-q8"):
            result = _map_unet_name_to_model_name("wan2.2-ti2v-5b")
            assert result == "Wan2.2-TI2V-5B-mlx-q8"

    def test_ltx2(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="ltx-2.3-mlx-q8"):
            result = _map_unet_name_to_model_name("ltx-2")
            assert result == "ltx-2.3-mlx-q8"

    def test_wan21_t2v_14b_routes_to_t2v_weights(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.1-T2V-14B") as fb:
    ...
    def test_wan21_fun_camera_routes_to_dedicated_dir(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.1-Fun-Camera-1.3B") as fb:
    ...
    def test_wan21_fun_camera_not_installed_falls_back(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.2-5B") as fb:
            result = _map_unet_name_to_model_name("wan2.1_fun_camera_v1.1_1.3B_bf16.safetensors")
            assert result == "Wan2.2-5B"
            fb.assert_called_once_with("Wan2.1-Fun-Camera-1.3B")
    ...
    def test_wan21_i2v_14b_routes_to_i2v_weights(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.1-14B") as fb:
    ...
    def test_svd(self):
        from fusion_comfyui.core.wrappers import _map_unet_name_to_model_name
        with patch("fusion_comfyui.core.wrappers._fallback_model", return_value="stable-video-diffusion-img2vid-xt"):
...
class TestMapVaeName:
    def test_wan22(self):
        from fusion_comfyui.core.wrappers import _map_vae_name_to_model_name
...
class TestResolveModelPath:
    def test_registry_hit(self):
        from fusion_comfyui.core.wrappers import _resolve_model_path
        with patch("fusion_mlx.public_api.get_registry") as mock_reg:
    ...
    def test_registry_exception(self):
        from fusion_comfyui.core.wrappers import _resolve_model_path
        with patch("fusion_mlx.public_api.get_registry", side_effect=ImportError):
    ...
    def test_dir_exists(self):
        from fusion_comfyui.core.wrappers import _resolve_model_path
        with patch("fusion_mlx.public_api.get_registry", return_value={}), \
    ...
    def test_fallback(self):
        ...
        with patch("fusion_mlx.public_api.get_registry", return_value={}), \
             ...
             patch("fusion_comfyui.core.wrappers._fallback_model", return_value="Wan2.2-5B"):
            result = _resolve_model_path("test-model")
